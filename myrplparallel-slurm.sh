...
# Submit this script with: sbatch rplparallel-slurm.sh
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:896152538583:awsnotify --message "RPLParallelJobDone"
