...
# Submit this script with: sbatch rplsplit-slurm.sh
...
aws sns publish --topic-arn \arn:aws:sns:ap-southeast-1:896152538583:awsnotify --message "RPLSplit_97-125_JobDone"
